        ...
        <div className="row">
            <div className="col-md">
                <div className="gallery-item gallery-style-5 mb-50 dark padding">
                    <a href="images/gallery/item-nature-1.jpg" className="image-popup">
                        <img src={require('../images/bear.jpg')} alt="" className="item-img"/>
                    </a>
                    <div className="item-title"><p><strong>Gallery item</strong></p></div>
                ...
                <div className="gallery-item gallery-style-5 mb-50 dark padding">
                    <a href="images/gallery/item-nature-2.jpg" className="image-popup">
                        <img src={require('../images/bear.jpg')} alt="" className="item-img"/>
                    </a>
                    <div className="item-title"><p><strong>Gallery item</strong></p></div>
                    <div className="item-icon"><svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 16 16" width="16" className="icon svg-default" src="images/gallery/icons/plus.svg" alt=""><path d="m9 7h7v2h-7v7h-2v-7h-7v-2h7v-7h2z" fillRule="evenodd"></path></svg></div>
            ...
            <div className="col-md">
                <div className="gallery-item gallery-style-5 mb-50 dark padding">
                    <a href="images/gallery/item-nature-3.jpg" className="image-popup">
                        <img src={require('../images/bear.jpg')} alt="" className="item-img"/>
                    </a>
                    <div className="item-title"><p><strong>Gallery item</strong></p></div>
                    <div className="item-icon"><svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 16 16" width="16" className="icon svg-default" src="images/gallery/icons/plus.svg" alt=""><path d="m9 7h7v2h-7v7h-2v-7h-7v-2h7v-7h2z" fillRule="evenodd"></path></svg></div>
                ...
                <div className="gallery-item gallery-style-5 mb-50 dark padding">
                    <a href="images/gallery/item-nature-4.jpg" className="image-popup">
                        <img src={require('../images/bear.jpg')} alt="" className="item-img"/>
                    </a>
                    <div className="item-title"><p><strong>Gallery item</strong></p></div>
                    <div className="item-icon"><svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 16 16" width="16" className="icon svg-default" src="images/gallery/icons/plus.svg" alt=""><path d="m9 7h7v2h-7v7h-2v-7h-7v-2h7v-7h2z" fillRule="evenodd"></path></svg></div>
